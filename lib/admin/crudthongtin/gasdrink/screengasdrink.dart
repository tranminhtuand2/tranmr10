...
import 'package:coffemanger/admin/crudthongtin/gasdrink/editpagegas.dart';
...
class updategasdrinks extends StatefulWidget {
  const updategasdrinks({super.key});

  @override
  State<updategasdrinks> createState() => _updategasdrinksState();
}

class _updategasdrinksState extends State<updategasdrinks> {
  @override
