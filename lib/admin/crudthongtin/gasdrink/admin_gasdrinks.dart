...
import 'package:coffemanger/admin/crudthongtin/gasdrink/screengasdrink.dart';
...
class crudgasdrinks extends StatefulWidget {
  const crudgasdrinks({super.key, required this.title});
  final String title;

  @override
  State<crudgasdrinks> createState() => _crudgasdrinksState();
}

class _crudgasdrinksState extends State<crudgasdrinks> {
                ...
                Center(
                  child: InkWell(
                    onTap: () {
                      ...
                      Firestorehelpergasdrinks.creategas(ProductModeCf(
                          namecf: _namecf.text,
                          typecf: _loaicf.text,
                ...
                IconButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => updategasdrinks(),
                          ));
                    },
