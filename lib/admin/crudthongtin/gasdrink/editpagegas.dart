...
class editpagegas extends StatefulWidget {
  ...
  @override
  State<editpagegas> createState() => _editpagegasState();
}

class _editpagegasState extends State<editpagegas> {
        ...
        child: Column(
          children: [
            ...
            Center(
              child: InkWell(
                onTap: () {
                  print(widget.productcf.namecf);
                  Firestorehelpergasdrinks.updategas(
                    ProductModeCf(
