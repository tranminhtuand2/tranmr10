...
import 'package:coffemanger/admin/crudthongtin/healthydrink/screenhealthy.dart';
...
class crudhealthy extends StatefulWidget {
  const crudhealthy({super.key, required this.title});
  final String title;

  @override
  State<crudhealthy> createState() => _crudhealthyState();
}

class _crudhealthyState extends State<crudhealthy> {
                ...
                Center(
                  child: InkWell(
                    onTap: () {
                      ...
                      Firestorehelperheathy.createhealthy(ProductModeCf(
                          namecf: _namecf.text,
                          typecf: _loaicf.text,
