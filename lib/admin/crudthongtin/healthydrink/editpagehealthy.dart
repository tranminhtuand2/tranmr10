...
class editpagehealthy extends StatefulWidget {
  final ProductModeCf productcf;
  const editpagehealthy({
    super.key,
    required this.productcf,
  });

  @override
  State<editpagehealthy> createState() => _editpagehealthyState();
}

class _editpagehealthyState extends State<editpagehealthy> {
            ...
            Center(
              child: InkWell(
                onTap: () {
                  ...
                  Firestorehelperheathy.updateheathy(
                    ProductModeCf(
