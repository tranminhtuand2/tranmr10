...
import 'package:coffemanger/admin/crudthongtin/millteas/screenmilkteas.dart';
...
class crudmilkteas extends StatefulWidget {
  const crudmilkteas({super.key, required this.title});
  final String title;

  @override
  State<crudmilkteas> createState() => _crudmilkteasState();
}

class _crudmilkteasState extends State<crudmilkteas> {
                ...
                Center(
                  child: InkWell(
                    onTap: () {
                      ...
                      Firestorehelpermilktea.createmilk(ProductModeCf(
                          namecf: _namecf.text,
                          typecf: _loaicf.text,
