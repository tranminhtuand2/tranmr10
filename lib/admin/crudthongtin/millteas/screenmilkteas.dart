...
import 'package:coffemanger/admin/crudthongtin/millteas/editgagemiiltea.dart';
...
class updatemilk extends StatefulWidget {
  ...
  @override
  State<updatemilk> createState() => _updatemilkState();
}

class _updatemilkState extends State<updatemilk> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
      appBar: AppBar(
        title: Text("admin view milkteas"),
      ),
